class EventsController < ApplicationController
  ...
  def destroy
    @event.destroy
    respond_to do |format|
      format.html { redirect_to calendar_url(@calendar), notice: "Event was successfully destroyed." }
  ...
  def event_params
    params.require(:event).permit(:calendar_id, :name, :color, :description, :duration, :type)
  end
end
